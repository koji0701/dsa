...
**realization: key/vals get set in timed order. its a timestamp, so its naturally 
...
class TimeMap:
    def __init__(self):
        self.mp = {} #key : [(timestamp, key)]
        #array is naturally sorted since timestamps land after one another
